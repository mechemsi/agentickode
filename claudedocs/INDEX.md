...
| [Docs & site agentic update](plans/2026-06-08-docs-agentic-update.md) | in-progress | 2026-06-08 | Part A done (README, CLAUDE.md, skills, legacy docs reframed to flow-prompt/ADR-009 model; RoleResolver→AgentResolver); Part B (agentickodeweb site) pending — separate repo |
