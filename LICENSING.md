...
For commercial use cases where the AGPLv3 terms are not suitable, a **Commercial License** is available.
...
All contributors must sign the [Contributor License Agreement](CLA.md) before their contributions can be merged. This ensures the project maintainers retain the ability to offer the software under both the open source and commercial licenses.
